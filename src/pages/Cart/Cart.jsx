...
import { addOnePizza, clearCart, deleteOnePizza, removeCartItem } from '../../redux/actions/cart';
               ...
               : <div className="cart">
                  ...
                  <div className="content__items">
                     {pizzasGroup.map(elem => <CartItem
                        ...
                        count={items[elem.id].pizzasArr.length}
